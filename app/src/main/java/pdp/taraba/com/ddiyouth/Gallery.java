 ...
 */
public class Gallery extends AppIntro {
    private int PERMISSION = 1;

    // DID NOT override onCreate. Used init
    @Override
    public void init(Bundle savedInstanceState) {
        if (ContextCompat.checkSelfPermission(Gallery.this, Manifest.permission.VIBRATE) == PackageManager.PERMISSION_GRANTED) {
//            Toast.makeText(this, "Permission GRANTED", Toast.LENGTH_SHORT).show();
        ...
        addSlide(AppIntroSlider.newInstance(R.layout.app_intro5));
        addSlide(AppIntroSlider.newInstance(R.layout.app_intro6));
        addSlide(AppIntroSlider.newInstance(R.layout.app_intro7));
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.VIBRATE)) {
            new AlertDialog.Builder(this).setTitle("Permission needed").setCancelable(false).setMessage("Permission needed for this activity").setPositiveButton("Permit", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ActivityCompat.requestPermissions(Gallery.this, new String[]{Manifest.permission.VIBRATE}, PERMISSION);
